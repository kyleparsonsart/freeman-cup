...
| Tests | 59 unit (21 scoring + 14 write queue + 8 feed + 6 moments + 6 card + 4 moment overlays). 12 RLS integration tests unchanged; run `npm test` from a real terminal (sandboxed agents can't reach Supabase) |
