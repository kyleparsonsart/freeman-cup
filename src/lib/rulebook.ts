...
export const RULEBOOK: Article[] = [
  ...
  {
    num: 3, title: 'Handicaps and strokes', gloss: 'GHIN, frozen · off the low player · 90% at four-ball',
    clauses: [
      { id: '3.1', title: 'Where your strokes come from', keys: ['dot', 'index', 'ghin', 'percent', 'allowance'],
        short: 'Your GHIN index, frozen before the trip. In every match the low player plays off scratch and everyone else gets the difference, on the hardest holes first. Singles is the full difference; four-ball is 90% of it.',
        long: ['Handicaps are each player’s GHIN index as of the Friday before the trip, rounded to the nearest whole number by the commissioner. They do not move Thursday through Saturday. No course conversions.',
          'The allowance follows the USGA: 100% of the difference at singles and aggregate, 90% at four-ball, where a partner throws your bad holes away and a stroke is worth more. Rounded to the nearest whole stroke, so a 15 against a 6 gets 8 at four-ball and 9 at singles.',
          'Strokes fall on the course’s stroke index, hardest hole first. Nobody gets two strokes on a hole this year.',
          'Your stroke holes show as a dot on the scorecard before the round starts.'], see: ['Art. 7.1'] },
      { id: '3.2', title: 'Four-ball', keys: ['better', 'ninety'],
        short: 'Strokes off the lowest of the four players in the match, at 90% of the difference. Your net score is your own; the better net ball on each side plays the hole.' },
      { id: '3.3', title: 'Aggregate at The Commons', keys: ['added', 'both', 'total', 'twelve'],
        short: 'Both net scores on a side are added and the lower total wins the hole. Full difference off the low player, scaled to twelve holes.',
        long: ['The Commons is twelve holes, so strokes are scaled by twelve eighteenths and rounded: a difference of 8 becomes 5.', 'Since both balls count, a pick-up (Art. 4) costs the team, not just you.'], see: ['Art. 4.2'] },
  ...
  },
  {
    ...
    clauses: [
      ...
      { id: '6.3', title: 'Sand', keys: ['sand', 'bunker', 'waste', 'ground', 'practice swing', 'rake'],
        short: 'All of Sand Valley’s sand is waste area, not a bunker. Ground your club, take a practice swing, move a loose impediment; then play it as it lies.',
        long: ['The courses are built on sand and most of it is unraked. There is no penalty for touching it before the stroke. Still no improving your lie, and no moving the ball. Rake what you leave behind where a rake is provided.'] },
  ...
  },
  {
    ...
    clauses: [
      { id: '11.1', title: 'Hole points', keys: ['mvp', 'points', 'player of the round', 'marker', 'solo', 'board', 'races'],
        ...
        long: [
          'Your ball won it alone when you held your side’s best net score and your partner did not match it. If both partners held the best net ball, the side won it together and each takes 1. At aggregate the sum wins the hole, but the points still go to the ball: the partner with the lower net score takes 2, and if the two net scores match each takes 1. At singles there is nobody to share with, so every hole won is 2.',
