...
const TYPE_ROLES: { role: string; where: string; size: string; spec: string; cls: string }[] = [
  { role: 'App title', where: 'Header', size: '21', spec: 'Young Serif · −0.015em', cls: '.hd h1' },
  { role: 'Section', where: 'Rosters, If we finish level', size: '19', spec: 'Young Serif · −0.015em', cls: '.sh h2' },
  { role: 'Round title', where: 'Course name on a round card', size: '19', spec: 'Young Serif · −0.015em', cls: '.rtop .t1' },
  { role: 'Day', where: 'Feed and schedule day headers', size: '17 / 18', spec: 'Young Serif · −0.015em', cls: '.dayhd .n · .dayrow .n' },
  { role: 'Group label', where: 'Settings sections', size: '16', spec: 'Young Serif · brass', cls: '.grp h3' },
  { role: 'Tab', where: 'Live · Scoring · Schedule', size: '16', spec: 'Young Serif', cls: '.tab' },
  { role: 'Player', where: 'Name on the hole card', size: '21', spec: 'Young Serif · −0.015em · team colour', cls: '.brow .bn' },
        ...
        <main className="ds-main">
          ...
          <section className="ds-sec" id="overview">
            ...
            <div className="ds-grid" style={{ marginTop: 28 }}>
              ...
              <a className="ds-card" href="#type" style={{ textDecoration: 'none' }}><div className="n">Type</div><div className="d">Young Serif, Work Sans, Barlow Condensed. Every integer is condensed</div></a>
            ...
            <p className="ds-p" style={{ marginTop: 22 }}>
              The type foundation started as Dado's, from Detail Binder; the display face became Young Serif on Sep 1. The rest is the prototype's, <code>freeman-cup-v66.html</code>,
          ...
          <section className="ds-sec" id="type">
            ...
            <p className="ds-lead">
              Young Serif carries the titles, Work Sans carries the reading, Barlow Condensed carries anything that counts. Sentence case throughout, including tags and buttons. The one rule people break: if it is an integer, it is condensed.
            </p>

            <h3 className="ds-h3">Families</h3>
            <div className="ds-grid">
              <div className="ds-card">
                <div className="ds-fam" style={{ fontFamily: 'var(--display)' }}>Aa Bb 0123</div>
                <div className="n">Display</div>
                <div className="d">Titles, section heads, day names, tabs, player names. One weight, self-hosted as a 20 KB Latin subset and declared across the whole weight range, so nothing ever synthesises a fake bold.</div>
          ...
          <section className="ds-sec" id="components">
            ...
            <D.Demo title="Group tabs" classes={['.ftabs', '.ftab', '.av', '.ft2', '.yo']} stage="board"
              note={<>When a round has more than one group, this full-width segmented control switches the hole card. Avatars carry the team colour; the state is condensed and coloured by who leads.</>}>
              <D.GroupTabs />
            </D.Demo>
          ...
          <section className="ds-sec" id="true">
            ...
            <p className="ds-p"><b>The font.</b> <code>public/fonts/YoungSerif-Regular.woff2</code> is a Latin subset cut from the original with fonttools. It has no ✓, → or ▾; those fall through to the next face in the stack. If a glyph is missing, re-subset with a wider range.</p>
